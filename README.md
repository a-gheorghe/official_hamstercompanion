This repo contains code that works alongside the code in the repo rodent_repo . In this project, we created the hardware and software to track rodent running behaviour for use in a research setting.
