    ...
    return (
      <div>
        ...
        <form className="col form" onSubmit={e => this.submit(e)}>
          ...
          />
          <input type="password" name="password" placeholder="Password to Join Experiment" value={undefined}/>
          <input type="text" name="desc" onChange={e => this.changeDesc(e)}
            placeholder="Description of your experiment" value={this.state.desc || undefined}
          />
          <input type="password" name="adminPassword" placeholder="Admin Password" value={undefined}/>
          <input type="password" name="adminPassRepeat" placeholder="Repeat Admin Password" value={undefined}/>
          { this.state.edit ?
